...
@Component({
  selector: 'app-diabetes-example',
  templateUrl: './diabetes-example.component.html',
  styleUrls: ['./diabetes-example.component.scss']
})
export class DiabetesExampleComponent implements OnInit {

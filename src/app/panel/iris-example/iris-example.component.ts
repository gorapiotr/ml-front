...
@Component({
  selector: 'app-iris-example',
  templateUrl: './iris-example.component.html',
  styleUrls: ['./iris-example.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class IrisExampleComponent implements OnInit {
